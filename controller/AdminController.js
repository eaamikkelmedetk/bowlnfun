...
module.exports.index = function (req, res) {
    async.series([
            ...
            function (callback) {
                Machine.find({centerId: req.params.selectedCenter}).exec().then(function (machines) {
...
module.exports.getCenter = function (req, res) {
    async.series([
        ...
        function (callback) {
            Machine.find({centerId: req.params.selectedCenterName}).exec().then(function (machines) {
                console.log(req.params.selectedCenterName);
                callback(null, machines);
            });
        }
    ], function (err, results) {
